<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="WebUserControl3.ascx.cs" Inherits="DXWebTemplate.WebUserControl3" %>
...
<dx:ASPxDocumentViewer ID="ASPxDocumentViewer1"  runat="server" ReportTypeName="DXWebTemplate.report_approve_requst">
