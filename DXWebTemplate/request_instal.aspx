<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="request_instal.aspx.cs" Inherits="DXWebTemplate.request_instal" %>
...
<body>
    <form id="form1" runat="server" > <%-- method="POST" action="Search_requst_instal.aspx"--%>
      <div>
        <table>
            <tr>
                ...
                <td>
                     <asp:Label ID="Label1" Font-Size="18px" runat="server" Text="การขอติดตั้งน้ำประปา"></asp:Label>
                </td>
                ...
                <td>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</td>
                  <td>
                   ...
                   <td>
                <a href="request_instal.aspx">  <img src="images/024.png" width="30" height="30"  />  <asp:Label ID="Label5" Font-Size="18px" runat="server" Text="รีเฟรช"></asp:Label>  </a>
                </td>
                <td>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</td>
               <td>
       ...
       <%--          <asp:Menu ID="Menu1" runat="server" ClientInstanceName="menuExport" OnMenuItemClick="Menu1_MenuItemClick" ClientVisible="true" >
                 ...
                 <td>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</td>
                <td>
                <a href="print_request_instal.aspx" target="_blank">  <img src="images/193.png" width="30" height="30"  />  <asp:Label ID="Label2" Font-Size="18px" runat="server" Text="พิมพ์"></asp:Label>  </a>
                </td>
