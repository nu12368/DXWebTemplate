<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="WebUserControl1.ascx.cs" Inherits="DXWebTemplate.WebUserControl1" %>
...
<dx:ASPxDocumentViewer ID="ASPxDocumentViewer1"  runat="server" ReportTypeName="DXWebTemplate.report_water_user">
