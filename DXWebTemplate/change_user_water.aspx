<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="change_user_water.aspx.cs" Inherits="DXWebTemplate.change_user_water" %>
...
<body>
    <form id="form1" runat="server" >  <%--method="POST" action="search_change_user_water.aspx"--%>
      <div>
        <table>
            <tr>
                <td>
                     <asp:Label ID="Label1" Font-Size="18px" runat="server" Text="ขอเปลี่ยนแปลงข้อมูล"></asp:Label>
                </td>
                <td>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</td>
                 <td>
                ...
                <td>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</td>
                 <td>
                <a href="change_user_water.aspx">  <img src="images/024.png" width="30" height="30"  />  <asp:Label ID="Label5" Font-Size="18px" runat="server" Text="รีเฟรช"></asp:Label>  </a>
                </td>
                 <td>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</td>
                <td>
...
<HideAdaptiveDetailButton ButtonType="Image"></HideAdaptiveDetailButton>
         ...
         <Columns>
            ...
            <dx:GridViewDataTextColumn FieldName="waterusernumber" Caption="เลขที่ผู้ใช้น้ำ" VisibleIndex="3"  HeaderStyle-HorizontalAlign="Center" HeaderStyle-Font-Size="12px" CellStyle-Font-Size="12px"  CellStyle-HorizontalAlign="Left" >
                    <HeaderStyle HorizontalAlign="Center"     />
                                                        <CellStyle HorizontalAlign="Center"  >
                                                        </CellStyle>
             </dx:GridViewDataTextColumn>
               ...
               <dx:GridViewDataTextColumn Caption=" เลขมาตรวัด" FieldName="numbergauge" HeaderStyle-Font-Size="12px" CellStyle-Font-Size="12px" VisibleIndex="10" HeaderStyle-HorizontalAlign="Center" CellStyle-HorizontalAlign="Left">
                                                        <HeaderStyle HorizontalAlign="Center" />
                                                        <CellStyle HorizontalAlign="Center">
                                                        </CellStyle>
                                    </dx:GridViewDataTextColumn>
             <dx:GridViewDataTextColumn Caption="เลขที่รับคำร้อง"  FieldName="numberpetition" HeaderStyle-Font-Size="12px" CellStyle-Font-Size="12px" VisibleIndex="11" HeaderStyle-HorizontalAlign="Center" CellStyle-HorizontalAlign="Left">
                                                        <HeaderStyle HorizontalAlign="Center" />
                                                        <CellStyle HorizontalAlign="Center">
                                                        </CellStyle>
                                    </dx:GridViewDataTextColumn>
                                       <dx:GridViewDataTextColumn Caption="วันที่รับคำร้อง"  FieldName="datepetition" HeaderStyle-Font-Size="12px" CellStyle-Font-Size="12px" VisibleIndex="12" HeaderStyle-HorizontalAlign="Center" CellStyle-HorizontalAlign="Left">
                                                        <HeaderStyle HorizontalAlign="Center" />
                                                        <CellStyle HorizontalAlign="Center">
                                                        </CellStyle>
                                    </dx:GridViewDataTextColumn>
            
                                                        <dx:GridViewDataTextColumn Caption="สถานะ" FieldName="status" HeaderStyle-Font-Size="12px" CellStyle-Font-Size="12px" VisibleIndex="13"   HeaderStyle-HorizontalAlign="Center" CellStyle-HorizontalAlign="Left">
                                                        <HeaderStyle HorizontalAlign="Center" />
...
<HideAdaptiveDetailButton ButtonType="Image"></HideAdaptiveDetailButton>
                                ...
                                <Columns>
                                      ...
                                      <dx:GridViewDataTextColumn Caption="นามสกุล" FieldName="lastname" VisibleIndex="5" HeaderStyle-Font-Size="16px" CellStyle-Font-Size="16px" HeaderStyle-HorizontalAlign="Center" CellStyle-HorizontalAlign="Left">
                                                        <HeaderStyle HorizontalAlign="Center" />
                                                        <CellStyle HorizontalAlign="Center">
                                                        </CellStyle>
                                    </dx:GridViewDataTextColumn>
                                      
                                        <dx:GridViewDataColumn FieldName="" Caption="ที่ตั้งมาตร" HeaderStyle-Font-Size="16px" CellStyle-Font-Size="16px" CellRowSpan="3" VisibleIndex="6" HeaderStyle-HorizontalAlign="Center" CellStyle-HorizontalAlign="Left">
            <Columns>
              
                      <dx:GridViewDataTextColumn Caption="เลขที่" FieldName="address"  VisibleIndex="7" HeaderStyle-Font-Size="16px" CellStyle-Font-Size="16px" HeaderStyle-HorizontalAlign="Center" CellStyle-HorizontalAlign="Left">
                                                        <HeaderStyle HorizontalAlign="Center"  />
                                                        <CellStyle HorizontalAlign="Center" >
                                                        </CellStyle>
                                    </dx:GridViewDataTextColumn>
                 
                                     <dx:GridViewDataTextColumn  Caption="หมู่ที่" FieldName="village" VisibleIndex="8" HeaderStyle-Font-Size="16px" CellStyle-Font-Size="16px" HeaderStyle-HorizontalAlign="Center" CellStyle-HorizontalAlign="Left">
                                                        <HeaderStyle HorizontalAlign="Center" />
                                                        <CellStyle HorizontalAlign="Center">
                                                        </CellStyle>
                                    </dx:GridViewDataTextColumn>
                                     ...
                                     <dx:GridViewDataTextColumn Caption="ตำบล" FieldName="district" VisibleIndex="9" HeaderStyle-Font-Size="16px" CellStyle-Font-Size="16px" HeaderStyle-HorizontalAlign="Center" CellStyle-HorizontalAlign="Left">
                                      ...
                                      <dx:GridViewDataTextColumn Caption=" เลขมาตรวัด" FieldName="numbergauge" HeaderStyle-Font-Size="16px" CellStyle-Font-Size="16px" VisibleIndex="10" HeaderStyle-HorizontalAlign="Center" CellStyle-HorizontalAlign="Left">
                                                        <HeaderStyle HorizontalAlign="Center" />
                                                        <CellStyle HorizontalAlign="Center">
                                                        </CellStyle>
                                    </dx:GridViewDataTextColumn>
                                                 <dx:GridViewDataTextColumn Caption="เลขที่รับคำร้อง"  FieldName="numberpetition" HeaderStyle-Font-Size="16px" CellStyle-Font-Size="16px" VisibleIndex="11" HeaderStyle-HorizontalAlign="Center" CellStyle-HorizontalAlign="Left">
                                                        <HeaderStyle HorizontalAlign="Center" />
                                                        <CellStyle HorizontalAlign="Center">
                                                        </CellStyle>
                                    </dx:GridViewDataTextColumn>
                                       <dx:GridViewDataTextColumn Caption="วันที่รับคำร้อง"  FieldName="datepetition" HeaderStyle-Font-Size="16px" CellStyle-Font-Size="16px" VisibleIndex="12" HeaderStyle-HorizontalAlign="Center" CellStyle-HorizontalAlign="Left">
                                                        <HeaderStyle HorizontalAlign="Center" />
                                                        <CellStyle HorizontalAlign="Center">
                                                        </CellStyle>
                                    </dx:GridViewDataTextColumn>
            
                                                        <dx:GridViewDataTextColumn Caption="สถานะ" FieldName="status" HeaderStyle-Font-Size="16px" CellStyle-Font-Size="16px" VisibleIndex="13"   HeaderStyle-HorizontalAlign="Center" CellStyle-HorizontalAlign="Left">
                                                        <HeaderStyle HorizontalAlign="Center" />
