<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="edit_water_user.aspx.cs" Inherits="DXWebTemplate.edit_water_user" %>
...
<body>
    <form id="form1" runat="server">   <%--method="POST" action="search_edit_water.aspx"--%>
      <div>
        <table>
            <tr>
                <td>
                     <asp:Label ID="Label1" Font-Size="18px" runat="server" Text="แก้ไขทะเบียนผู้ใช้น้ำ"></asp:Label>
                </td>
                <td>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</td>
                  <td>
                ...
                <td>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</td>
                    <td>
                <a href="edit_water_user.aspx">  <img src="images/024.png" width="30" height="30"  />  <asp:Label ID="Label5" Font-Size="18px" runat="server" Text="รีเฟรช"></asp:Label>  </a>
                </td>
                 <td>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</td>
                <td>
         ...
         <Columns>
            ...
            <dx:GridViewDataTextColumn FieldName="waterusernumber" Caption="เลขที่ผู้ใช้น้ำ" VisibleIndex="3"  HeaderStyle-HorizontalAlign="Center" HeaderStyle-Font-Size="12px" CellStyle-Font-Size="12px"  CellStyle-HorizontalAlign="Left" >
               ...
               <dx:GridViewDataTextColumn FieldName="username" Caption="ชื่อผู้ใช้น้ำ"  VisibleIndex="4" HeaderStyle-HorizontalAlign="Center" HeaderStyle-Font-Size="12px" CellStyle-Font-Size="12px" CellStyle-HorizontalAlign="Left" >
                   ...
                   <dx:GridViewDataTextColumn  Caption="เลขมาตรวัด" FieldName="numbergauge" VisibleIndex="9"  HeaderStyle-HorizontalAlign="Center" HeaderStyle-Font-Size="12px" CellStyle-Font-Size="12px"  CellStyle-HorizontalAlign="Left" >
                    <HeaderStyle HorizontalAlign="Center"     />
                                                        <CellStyle HorizontalAlign="Center"  >
                                                        </CellStyle>
             </dx:GridViewDataTextColumn>
               <dx:GridViewDataTextColumn Caption=" สถานะ VIP" FieldName="status" VisibleIndex="10"  HeaderStyle-HorizontalAlign="Center" HeaderStyle-Font-Size="12px" CellStyle-Font-Size="12px" CellStyle-HorizontalAlign="Left" >
                    <HeaderStyle HorizontalAlign="Center"     />
                                                        <CellStyle HorizontalAlign="Center"  >
                                                        </CellStyle>
             </dx:GridViewDataTextColumn>
                    ...
                    <dx:GridViewBandColumn Caption="สถานะตรวจ" HeaderStyle-Font-Size="12px"  VisibleIndex="11" HeaderStyle-HorizontalAlign="Center">
                        <Columns>
                            <dx:GridViewDataTextColumn Caption="ตรวจสอบ"   FieldName="check_status" HeaderStyle-Font-Size="12px" CellStyle-Font-Size="12px"  VisibleIndex="13" HeaderStyle-HorizontalAlign="Center" CellStyle-HorizontalAlign="Left">
                                                        <HeaderStyle HorizontalAlign="Center" />
                                                        <CellStyle HorizontalAlign="Center">
                                                        </CellStyle>
                            <DataItemTemplate>
                                       <a href="javascript:void()" id="a1" onclick="status('<%# Eval("id")%>');"   style="text-decoration: none;">
                                           <dx:ASPxCheckBox ID="ASPxCheckBox1" runat="server"></dx:ASPxCheckBox>
                                            </a>
                                       </DataItemTemplate>
                                    </dx:GridViewDataTextColumn>
                                                        <dx:GridViewDataTextColumn Caption="ลบ" FieldName="delete_status" HeaderStyle-Font-Size="12px" CellStyle-Font-Size="12px" VisibleIndex="14"   HeaderStyle-HorizontalAlign="Center" CellStyle-HorizontalAlign="Left">
                                                        <HeaderStyle HorizontalAlign="Center" />
                                                       <DataItemTemplate>
                                       <a href="javascript:void()" id="a1" onclick="status('<%# Eval("id")%>');"   style="text-decoration: none;">
                                           <dx:ASPxCheckBox ID="ASPxCheckBox1" runat="server"></dx:ASPxCheckBox>
...
<CellStyle HorizontalAlign="Left" Font-Size="12px"></CellStyle>
                                    </dx:GridViewDataTextColumn>
                        </Columns>
                    </dx:GridViewBandColumn>
...
<CellStyle HorizontalAlign="Left" Font-Size="16px"></CellStyle>
            <Columns>
                      ...
                      <dx:GridViewDataTextColumn Caption="เลขที่" FieldName="address"  VisibleIndex="7" HeaderStyle-Font-Size="16px" CellStyle-Font-Size="16px" HeaderStyle-HorizontalAlign="Center" CellStyle-HorizontalAlign="Left">
                                     ...
                                     <dx:GridViewDataTextColumn Caption="ตำบล" FieldName="district" VisibleIndex="9" HeaderStyle-Font-Size="16px" CellStyle-Font-Size="16px" HeaderStyle-HorizontalAlign="Center" CellStyle-HorizontalAlign="Left">
                                      ...
                                      <dx:GridViewDataTextColumn Caption=" สถานะ VIP" FieldName="status" HeaderStyle-Font-Size="16px" CellStyle-Font-Size="16px" VisibleIndex="11" HeaderStyle-HorizontalAlign="Center" CellStyle-HorizontalAlign="Left">
                                                        <HeaderStyle HorizontalAlign="Center" />
                                                        <CellStyle HorizontalAlign="Center">
                                                        </CellStyle>
                                    </dx:GridViewDataTextColumn>
...
<CellStyle HorizontalAlign="Left" Font-Size="16px"></CellStyle>
            <Columns>
                                     ...
                                     <dx:GridViewDataTextColumn Caption="ตรวจสอบ"   FieldName="check_status" HeaderStyle-Font-Size="16px" CellStyle-Font-Size="16px"  VisibleIndex="13" HeaderStyle-HorizontalAlign="Center" CellStyle-HorizontalAlign="Left">
                                                        <HeaderStyle HorizontalAlign="Center" />
                                                        <CellStyle HorizontalAlign="Center">
                                                        </CellStyle>
                            <DataItemTemplate>
                                       <a href="javascript:void()" id="a1" onclick="status('<%# Eval("id")%>');"   style="text-decoration: none;">
                                           <dx:ASPxCheckBox ID="ASPxCheckBox1" runat="server"></dx:ASPxCheckBox>
                                                        ...
                                                        <dx:GridViewDataTextColumn Caption="ลบ" FieldName="delete_status" HeaderStyle-Font-Size="16px" CellStyle-Font-Size="16px" VisibleIndex="14"   HeaderStyle-HorizontalAlign="Center" CellStyle-HorizontalAlign="Left">
                                                        <HeaderStyle HorizontalAlign="Center" />
                                                       <DataItemTemplate>
                                       <a href="javascript:void()" id="a1" onclick="status('<%# Eval("id")%>');"   style="text-decoration: none;">
                                           <dx:ASPxCheckBox ID="ASPxCheckBox1" runat="server"></dx:ASPxCheckBox>
