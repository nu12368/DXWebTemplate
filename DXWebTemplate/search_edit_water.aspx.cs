...
{
    public partial class search_edit_water : System.Web.UI.Page
    {
        string prm = "";
        string Str_return = "";
        protected void Page_Load(object sender, EventArgs e)
        {
            try
            {
                if (Request["t1"] != "" || Request["t2"] != "" || Request["t3"] != "" || Request["t4"] != "" || Request["t5"] != "" || Request["t6"] != "" || Request["t7"] != "")
                {
                    ...
                    Response.Redirect("edit_water_user.aspx?prmsearch=" + Str_return + "");
                }
                else
                {
                    if (Request["SubmitSearch"] != "" && Request["SubmitSearch"] != null)
                    {
                        ...
                        Response.Redirect("edit_water_user.aspx?notinput=" + "notinput");
                    }
                    else
                    {
                        ////// Response Export
                        Response.Redirect("edit_water_user.aspx?export=" + "export");
                    }
                }
            }
            catch (Exception ex)
