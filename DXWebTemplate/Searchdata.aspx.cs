        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            
            {
                if (Request["t1"] != "" || Request["t2"] != "" || Request["t3"] != "" || Request["t4"] != "" || Request["t5"] != "" || Request["t6"] != "" || Request["t7"] != "")
                {
                    ...
                    Response.Redirect("water_user.aspx?prmsearch=" + Str_return + "");
                }
                else
                {
                    if (Request["SubmitSearch"] != "" && Request["SubmitSearch"] != null )
                    {
                        ...
                        Response.Redirect("water_user.aspx?notinput=" + "notinput");
                    }
                    else
                    {
                        ////// Response Export
                        Response.Redirect("water_user.aspx?export=" + "export");
                    }
                }
