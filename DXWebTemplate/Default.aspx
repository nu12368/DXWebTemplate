        ...
        <table style="border-collapse: collapse; width: 100%;">
                ...
                <td>
                    ...
                    <dx:ASPxPanel ID="panelProfile" runat="server" ClientInstanceName="panelProfile"
                        ...
                        <PanelCollection>
                                                        ...
                                                        <table style="margin-left:-25px;">
                                                            <tr>
                                                             <td style="font-size: 16pt; text-shadow: 1px 1px #BDBDBD; color: Blue;">
                                                                   &nbsp; &nbsp;  ระบบบริหารจัดการน้ำประปาท่าโขลง
                                                                </td>
                                                   <%-- <td style="font-size: 16pt; text-shadow: 1px 1px #BDBDBD; color: Blue;">
                                                        &nbsp;S
                                                    </td>
                            ...
                            <a href="login.aspx" style="font-size:16px;">[ออกจากระบบ]</a>
                     </td>
                                                 </tr>
                                             </table>
                                        </td>
            ...
            <Image IconID="grid_customizegrid_32x32">
                                                    ...
                                                    <td  style="vertical-align: middle;">
                                                      ...
                                                      <%--      <dx:ASPxLabel ID="lbAdmin" ToolTip="����Ѻ�������к�" runat="server" Cursor="pointer"
                                                                ForeColor="#0080FF" Text="����Ѻ�������к�">
                                                                <ClientSideEvents Click="function(s,e){
                                                                        var left1 = window.event.clientX + document.body.scrollLeft + document.documentElement.scrollLeft;
                                                                        var top1 = window.event.clientY + document.body.scrollTop + document.documentElement.scrollTop;
                                                    ...
                                                    <td style=" cursor:pointer;"> <a onclick="CallAlert();" title="����ͺ����Ǩ�������"  class="notif" style="text-decoration:none;"><span class="num"><dx:ASPxLabel runat="server" ID="lbAlert" ClientInstanceName="lbAlert"></dx:ASPxLabel></span></a></td>
                                                   <td>&nbsp;</td>
                                                    <td >
                                                    ...
                                                    <td  style="vertical-align: middle;">
                                                        <div>
                                                            ...
                                                            <dx:ASPxLabel ID="profile_hrm" ToolTip="�����ҹ" runat="server" Cursor="pointer"
                                                                ForeColor="#0080FF" Text="�����ҹ">
                                                                <ClientSideEvents Click="function(s,e){
                                                                        var left1 = window.event.clientX + document.body.scrollLeft + document.documentElement.scrollLeft;
                                                                        var top1 = window.event.clientY + document.body.scrollTop + document.documentElement.scrollTop;
...
<dx:SplitterContentControl runat="server">
            ...
            <dx:PopupControlContentControl ID="PopupControlContentControl5" runat="server">
               <table style="display:none;">
                   <tr id="tr1" onmouseover="GetLink(0,1)" onmouseout="GetLink(1,1)" style="height:30px; cursor:pointer;" onclick="CallAdmin(1)">
                       <td><img src="images/menu_icon/1-1.png" title="��˹��Է�������ҹ" /></td>
                       <td><dx:ASPxLabel runat="server" ID="lbM1" Text="��˹��Է�������ҹ"></dx:ASPxLabel></td>
                   </tr>
                   <tr id="tr2" onmouseover="GetLink(0,2)" onmouseout="GetLink(1,2)" style="height:30px; cursor:pointer;" onclick="CallAdmin(2)">
                       <td><img src="images/menu_icon/_1.3.png" title="������ ���./���/�Ҩ����" /></td>
                       <td><dx:ASPxLabel runat="server" ID="ASPxLabel6" Text="������ ���./���/�Ҩ����"></dx:ASPxLabel></td>
                   </tr>
                   <tr id="tr3" onmouseover="GetLink(0,3)" onmouseout="GetLink(1,3)" style="height:30px; cursor:pointer;" onclick="CallAdmin(3)">
                       <td><img src="images/menu_icon/_1.4.png" title="�����š���������Ԫ�" /></td>
                       <td><dx:ASPxLabel runat="server" ID="ASPxLabel9" Text="�����š���������Ԫ�"></dx:ASPxLabel></td>
                   </tr>
                   <tr id="tr4" onmouseover="GetLink(0,4)" onmouseout="GetLink(1,4)" style="height:30px; cursor:pointer;" onclick="CallAdmin(4)">
                       <td><img src="images/menu_icon/_1.5.png" title="����������Ԫ�" /></td>
                       <td><dx:ASPxLabel runat="server" ID="ASPxLabel10" Text="����������Ԫ�"></dx:ASPxLabel></td>
                   </tr>
                   <tr id="tr5" onmouseover="GetLink(0,5)" onmouseout="GetLink(1,5)" style="height:30px; cursor:pointer;" onclick="CallAdmin(5)">
                       <td><img src="images/menu_icon/_1.1.png" title="�����š���ͺ������" /></td>
                       <td><dx:ASPxLabel runat="server" ID="ASPxLabel11" Text="�����š���ͺ������"></dx:ASPxLabel></td>
                   </tr>
            ...
            <dx:PopupControlContentControl ID="PopupControlContentControl2" runat="server">
                    ...
                    <tr>
                        ...
                        <td style="vertical-align: top;">
                            <table style="width: 100%;">
                                ...
                                <tr>
                                    <td style="text-align: right;">
                                        <dx:ASPxLabel ID="ASPxLabel1" runat="server" Text="����-���ʡ�� :">
                                        </dx:ASPxLabel>
                                    </td>
                                    <td>
                                ...
                                <tr style="display:none;">
                                    <td style="text-align: right;">
                                        <dx:ASPxLabel ID="ASPxLabel5" runat="server" Text="Ἱ� :">
                                        </dx:ASPxLabel>
                                    </td>
                                    <td>
                ...
                <table style="width: 100%; display:none;">
                    <tr> 
                        ...
                        <td style="text-align: right;">
                            <dx:ASPxButton ID="btnLogout" runat="server" Text=" �͡�ҡ�к� " AutoPostBack="false">
                                <ClientSideEvents Click="function(s,e){
        ...
        <ContentCollection>
            <dx:PopupControlContentControl ID="PopupControlContentControl3" runat="server">
                <table style="width: 100%;">
                    <tr>
                        <td>
                            <dx:ASPxLabel ID="lbResult" runat="server" ClientInstanceName="lbResult" Text="�س��ͧ��÷����͡�ҡ�к� ?">
                            </dx:ASPxLabel>
                        </td>
                    </tr>
                    <tr>
                    ...
                    <tr>
                        <td>
                            <dx:ASPxButton ID="ASPxButton1" runat="server" Text="   ��ŧ   " AutoPostBack="false"
                                Width="80px">
                                <ClientSideEvents Click="function(s,e){
                            ...
                            <dx:ASPxButton ID="btnClose" runat="server" Text="   ¡��ԡ   " AutoPostBack="false"
                                Width="80px">
 ...
 <dx:ASPxPopupControl ID="popEditProfile" runat="server" CloseAction="CloseButton"
                                ...
                                <tr>
                                    <td style="text-align:center;">
                                        ...
                                        <dx:ASPxUploadControl ID="uplImageEdit" runat="server" ClientInstanceName="uploaderEdit" ClientEnabled="true" ShowClearFileSelectionButton="False"
                                                BrowseButton-Text="����ٻ" ShowProgressPanel="True" Width="1px" > 
                                ...
                                <tr>
                                    <td>
                                        <dx:ASPxButton ID="btnConfirmSent" runat="server" ClientInstanceName="btnConfirmSent"
                                            AutoPostBack="false" Text="�ѹ�֡������" Image-IconID="businessobjects_boresume_16x16">
                                            <ClientSideEvents Click="function(s,e){
                                                                        //alert(cmbPerList.GetValue());
                                                            if(txtPwdOld.GetText()==''){
                                                                 lbChkWn.SetText('! ��س����͡��͡���ʼ�ҹ���');
                                                                 txtPwdOld.SetFocus(true);
                                                                 return false;
                                    ...
                                    <td>
                                        <dx:ASPxButton ID="ASPxButton6" runat="server" ClientInstanceName="btnConfirmSent"
                                            AutoPostBack="false" Text="¡��ԡ" Image-IconID="actions_cancel_16x16">
                                            <ClientSideEvents Click="function(s,e){
                                                                        popEditProfile.Hide();
                                                                     }" />
                                        </dx:ASPxButton>
        ...
        <dx:ASPxPopupControl ID="PopupSaveComplete" runat="server" CloseAction="CloseButton"
                                            Modal="True" Width="300px" Height="100px" PopupHorizontalAlign="WindowCenter"
                                            PopupVerticalAlign="WindowCenter" ClientInstanceName="PopupSaveComplete" HeaderText="�š�úѹ�֡."
                                            AllowDragging="True" PopupAnimationType="None" EnableViewState="False" ShowCloseButton="true">
                                            ...
                                            <ContentCollection>
                                                <dx:PopupControlContentControl ID="PopupControlContentControl8" runat="server">
                                                    <table style="width: 100%;">
                                                        ...
                                                        <tr>
                                                            <td>
                                                                <dx:ASPxButton ID="ASPxButton8" runat="server" Text="   ��ŧ   " AutoPostBack="false"
                                                                    Width="80px">
                                                                    <ClientSideEvents Click="function(s,e){
        ...
        <dx:ASPxPopupControl ID="popupAlert" runat="server" CloseAction="CloseButton" Modal="True"
            ...
            ClientInstanceName="popupAlert" AllowDragging="True" HeaderText ="��Ǩ�礡������͹."
